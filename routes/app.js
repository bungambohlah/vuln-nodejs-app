...
//   "/sitetoken/:username",
//   authenticateToken,
//   vuln_controller.sitetoken_get
// );

// router.get(
//   "/sqli/:from-:to",
//   authenticateToken,
//   vuln_controller.sqli_check_train_get
// );

// router.get(
//   "/sqli-fixed/:from-:to",
//   authenticateToken,
//   vuln_controller.fixed_sqli_check_train_get
// );
...
router.get(
  "/deserialization",
  authenticateToken,
  vuln_controller.deserialization_get
);

router.post(
  "/save-preference",
  authenticateToken,
  vuln_controller.save_preference_post
);
...
//   "/ticket/booking",
//   authenticateToken,
//   vuln_controller.ticket_booking_get
// );
...
// router.get(
//   "/organization/myorg/users",
//   authenticateToken,
//   vuln_controller.myorg_users_get
// );
...
//   "/api-token/show",
//   authenticateToken,
//   vuln_controller.apitokenShow_get
// );

// router.get(
//   "/cors-api-token",
//   authenticateToken,
//   vuln_controller.cors_api_token_get
// );

// router
//   .route("/cors-csrf-edit-password")
...
//   "/disable-totp",
//   authenticateToken,
//   vuln_controller.totp_disable_post
// );

// router.get(
//   "/cross-site-websocket-hijacking",
//   authenticateToken,
//   vuln_controller.websocket_hijacking_get
// );

// router.get(
//   "/websocket-xss",
//   authenticateToken,
//   vuln_controller.websocket_xss_get
// );
...
// router
//   .route("/mongodb-notes/show-notes")
...
//   authenticateToken,
//   vuln_controller.graphql_user_profile_get
// );

// router.get(
//   "/graphql-information-disclosure",
//   authenticateToken,
//   vuln_controller.graphql_information_disclosure_get
// );

// router.get(
//   "/graphql-update-profile",
//   authenticateToken,
//   vuln_controller.graphql_update_profile_get
// );

// router.get(
//   "/graphql-idor-show-profile",
//   authenticateToken,
//   vuln_controller.graphql_idor_get
// );
...
//   "/jsonp-injection",
//   authenticateToken,
//   vuln_controller.jsonp_injection_get
// );

// router.get(
//   "/jsonp-injection/wallet-usd-balance",
//   authenticateToken,
//   vuln_controller.jsonp_wallet_get
// );

// router.get(
//   "/nosql-js-injection",
//   authenticateToken,
//   vuln_controller.nosql_javascript_injection_get
// );
